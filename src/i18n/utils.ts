...
export const ui = {
  en: {
    ...
    appSupportsDevices:
      "This app supports Volcano Hybrid, Veazy, Venty and Crafty devices. Click the button below to connect via Bluetooth.",
    ...
    importWorkflow: "Import Single Workflow",
  ...
  de: {
    ...
    importWorkflow: "Einzelnen Workflow importieren",
